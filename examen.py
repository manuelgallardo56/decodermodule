# -*- coding: utf-8 -*-
"""
Created on Fri May  8 18:11:50 2020
...
def decodes(code,advancekey):
	...
	while length_iterator < len(code_upper):
		...
		if char_to_explore.isdigit():
			...
			index_list_d = list_number.index(char_to_explore)
			decode_index_d = index_list_d + int(advancekey)
			decoded_string = decoded_string + list_number[decode_index_d]
...
def main():
	...
	print ("-------- RebelAllianceDecoderModule - Que la fuerza Nos Acompañe ---------")
